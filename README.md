...
[![Version](https://img.shields.io/badge/version-0.3.0--dev.2-orange?style=for-the-badge)](https://github.com/cvquesty/openvox-ovbuilder/releases)
...
|------------------------|---------------|-------|
| **ovbuilder CLI**      | `0.3.0-dev.2` | Typer + Rich + pyVmomi. Live vCenter discovery. |
