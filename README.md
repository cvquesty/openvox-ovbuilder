...
[![Version](https://img.shields.io/badge/version-0.2.0--dev.17-orange?style=for-the-badge)](https://github.com/cvquesty/openvox-ovbuilder/releases)
...
|------------------------|---------------|-------|
| **ovbuilder CLI**      | `0.2.0-dev.17` | Typer + Rich + pyVmomi. Live vCenter discovery. |
